...
(function($) {
	...
	$.anchorfy = {
		defaults: {
			animate:		false, // Animate scrolling to anchor
			duration:		1500, // Animation time
			ease:			"swing", // Animation easing effect
			anchorsElement:	'.anchors', // Where the anchor list will appear
			anchorsPrefix:	'heading', // Custom prefix of anchor name
			anchorsSuffix:	'', // Custom suffix of anchor name
			wrapperClass:	'anchorfy_wrapper', // Name of container for links
			innerClass:		'anchorfy_inner', // Name of item inside container
			wrapperMarkup:	'', // Custom markup for link container
			innerMarkup:	'', // Custom markup for link item
			anchorMarkup:	'' // Custom markup for anchor
		}
	};
